...
-task ${task} \
--output-name ${pwd}/onnx_models/${task}_siou_${size}_20220915.v3.onnx \
-f ${pwd}/exps/default/yolox_all.py \
-c /world/data-gpu-94/wyq/cfg_yolox/trained_models/hands_goods_det_v3/yolox_all/epoch_99_ckpt.pth 
